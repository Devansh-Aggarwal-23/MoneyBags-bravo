...
import com.moneybags.cif.integration.KycServiceClient;
...
public class CifServiceImpl implements CifService {
    ...
    public CifResponse createCif(CreateCifRequest request) {
        ...
        KycVerificationRequest kycRequest = toKycVerificationRequest(savedCif);
        kycServiceClient.initiateKycVerification(kycRequest);
    ...
    public CifResponse updateCif(Long cifId, UpdateCifRequest request) {
        ...
        KycVerificationRequest kycRequest =
                toKycVerificationRequest(updatedCif);
